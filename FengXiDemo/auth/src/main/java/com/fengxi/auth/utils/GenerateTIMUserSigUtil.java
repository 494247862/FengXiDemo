 ...
 * @author liuqihong
 * @description: TODO
 * @title: GenerateTIMUserSigUtil
 * @projectName FengXiDemo
 */
public class GenerateTIMUserSigUtil {
    final private static long sdkappid = 1400796903;
    final private static String key = "bea56a33027da883b1d9db69ad10756e7b49c346e7f337f1463ad35281a43b58";
    ...
    public String genUserSig(String userid) {
        return genUserSig(userid, 600, null);
    }
